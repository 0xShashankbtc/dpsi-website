      ...
      <header className="sticky top-0 z-50 w-full transform-gpu">
        ...
        <div className="bg-emerald-900 text-white text-xs pt-[max(0.5rem,env(safe-area-inset-top))] pb-2 overflow-hidden border-b border-emerald-700/50">
          <div className="w-full max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-1.5 sm:gap-2.5 text-[10px] sm:text-[11px] font-bold text-white shrink-0">
              <motion.a
                ...
                className="hidden md:inline-block px-2.5 sm:px-3 py-1 bg-amber-400 hover:bg-amber-300 text-slate-950 rounded shadow-md transition-all font-extrabold"
              >
                SchoolsOS Login
              </motion.a>
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="px-2 sm:px-2.5 py-0.5 sm:py-1 bg-sky-600 hover:bg-sky-500 text-white rounded transition-all block font-bold flex items-center gap-1 shadow-xs"
              ...
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="px-2 sm:px-2.5 py-0.5 sm:py-1 bg-purple-600 hover:bg-purple-500 text-white rounded transition-all block font-bold flex items-center gap-1 shadow-xs"
                  title="Robot"
                >
        ...
        <div className="w-full max-w-[1600px] mx-auto px-3 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-14 sm:h-18 lg:h-22 gap-2 sm:gap-3 xl:gap-6">
            ...
            <div className="flex items-center gap-1.5 sm:gap-2 xl:gap-2.5 shrink-0 z-20">
              ...
              {/* Mobile Direct Robot Trigger */}
              <a
                href="https://dpsirobot.vercel.app"
                target="_blank"
                rel="noopener noreferrer"
                className="lg:hidden flex items-center gap-1 px-2.5 py-1.5 rounded-xl bg-purple-600 hover:bg-purple-700 text-white text-xs font-bold shadow-xs active:scale-95 transition-all touch-manipulation cursor-pointer"
                title="DPSI Robot"
                aria-label="Open DPSI Robot in new tab"
              >
              ...
              <motion.button
                ...
                className="w-10 h-10 sm:w-11 sm:h-11 flex items-center justify-center rounded-full bg-slate-100 dark:bg-slate-800 hover:bg-emerald-50 dark:hover:bg-emerald-950/40 transition-colors cursor-pointer shrink-0 touch-manipulation"
              ...
              <motion.button
                ...
                className="lg:hidden w-10 h-10 sm:w-11 sm:h-11 flex items-center justify-center rounded-xl bg-slate-100 dark:bg-slate-800 text-slate-800 dark:text-slate-100 hover:bg-emerald-50 dark:hover:bg-emerald-950/40 transition-colors cursor-pointer shrink-0 touch-manipulation"
              ...
              >
                ...
                <div className="flex items-center gap-2 overflow-x-auto pb-1.5 no-scrollbar -mx-1 px-1 touch-pan-x">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="px-3.5 py-2 rounded-xl text-xs font-bold text-sky-700 dark:text-sky-300 bg-sky-50 dark:bg-sky-950/60 border border-sky-200/80 dark:border-sky-800/60 flex items-center gap-1.5 shrink-0 shadow-xs active:scale-95 transition-transform cursor-pointer"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="px-3.5 py-2 rounded-xl text-xs font-bold text-purple-700 dark:text-purple-300 bg-purple-50 dark:bg-purple-950/60 border border-purple-200/80 dark:border-purple-800/60 flex items-center gap-1.5 shrink-0 shadow-xs active:scale-95 transition-transform cursor-pointer"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="px-3.5 py-2 rounded-xl text-xs font-bold text-amber-900 dark:text-amber-200 bg-amber-100/80 dark:bg-amber-950/60 border border-amber-300/70 dark:border-amber-700/60 flex items-center gap-1.5 shrink-0 shadow-xs active:scale-95 transition-transform cursor-pointer"
                  >
